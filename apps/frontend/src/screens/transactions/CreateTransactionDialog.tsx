...
import { dateInputToISO, parseAmountInput } from './utils'
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl">
        <div className="mb-6 flex items-start justify-between">
          <div>
            <h2 className="text-xl font-semibold text-text-heading">Nova transação</h2>
            <p className="mt-1 text-sm text-text-primary">Registre sua despesa ou receita</p>
          </div>
          <button
            type="button"
            onClick={onClose}
